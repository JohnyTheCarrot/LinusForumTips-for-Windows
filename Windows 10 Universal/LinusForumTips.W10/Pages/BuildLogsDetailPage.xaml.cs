//---------------------------------------------------------------------------
//
// <copyright file="BuildLogsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class BuildLogsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public BuildLogsDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new BuildLogsSection());
