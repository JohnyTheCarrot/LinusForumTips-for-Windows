...
{
    public class GuidesAndTutorialsSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public GuidesAndTutorialsSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.GuidesAndTutorialsListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.GuidesAndTutorialsDetailPage>(true);
                    }
                };
            }
        }
