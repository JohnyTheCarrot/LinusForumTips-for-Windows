...
namespace LinusForumTips.Sections
{
    public class ChannelSuperFunVideosSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public ChannelSuperFunVideosSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Channel Super Fun Videos",

                    Page = typeof(Pages.ChannelSuperFunVideosListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.ChannelSuperFunVideosDetailPage>(true);
                    }
                };
            }
        }
