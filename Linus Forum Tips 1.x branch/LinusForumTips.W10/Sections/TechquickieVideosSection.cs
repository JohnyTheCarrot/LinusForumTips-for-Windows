...
{
    public class TechquickieVideosSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public TechquickieVideosSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.TechquickieVideosListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.TechquickieVideosDetailPage>(true);
                    }
                };
            }
        }
