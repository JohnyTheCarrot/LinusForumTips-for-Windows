//---------------------------------------------------------------------------
//
// <copyright file="BuildGuidesDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class BuildGuidesDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public BuildGuidesDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new BuildGuidesSection());
