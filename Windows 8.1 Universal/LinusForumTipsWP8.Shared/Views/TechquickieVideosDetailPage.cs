...
{
    public sealed partial class TechquickieVideosDetailPage : PageBase
    {
        ...
        public TechquickieVideosDetailPage()
               : base(true)
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new TechquickieVideosConfig());
