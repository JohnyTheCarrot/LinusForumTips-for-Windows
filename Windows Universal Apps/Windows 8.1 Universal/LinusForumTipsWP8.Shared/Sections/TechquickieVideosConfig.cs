...
{
    public class TechquickieVideosConfig : SectionConfigBase<YouTubeDataConfig, YouTubeSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("TechquickieVideosListPage");
            }
        }
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("TechquickieVideosDetailPage", true);
                    }
                };
            }
        }
