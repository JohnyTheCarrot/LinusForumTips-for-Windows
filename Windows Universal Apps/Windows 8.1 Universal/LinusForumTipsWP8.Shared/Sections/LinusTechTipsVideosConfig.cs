...
{
    public class LinusTechTipsVideosConfig : SectionConfigBase<YouTubeDataConfig, YouTubeSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("LinusTechTipsVideosListPage");
            }
        }
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("LinusTechTipsVideosDetailPage", true);
                    }
                };
            }
        }
        ...
        {
            get { return "Linus Tech Tips Videos"; }
        }
