...
{
    public sealed partial class WanShowArchiveDetailPage : PageBase
    {
        ...
        public WanShowArchiveDetailPage()
               : base(true)
        {
            this.ViewModel = new DetailViewModel<YouTubeDataConfig, YouTubeSchema>(new WanShowArchiveConfig());
