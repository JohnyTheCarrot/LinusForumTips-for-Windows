...
{
    public class WanShowArchiveSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public WanShowArchiveSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.WanShowArchiveListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.WanShowArchiveDetailPage>(true);
                    }
                };
            }
        }
